...
if(@$_GET['demail'] && $_SESSION['key']=='arti7785068889') {
$demail=@$_GET['demail'];
$r1 = mysqli_query($con,"DELETE FROM rank WHERE email='$demail' ") or die('Error');
$r2 = mysqli_query($con,"DELETE FROM history WHERE email='$demail' ") or die('Error');
$result = mysqli_query($con,"DELETE FROM student WHERE email='$demail' ") or die('Error');
header("location:dash.php?q=1");
}
}
//remove exam
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmexam' && $_SESSION['key']=='arti7785068889') {
$eid=@$_GET['eid'];
...
//add exam
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addexam' && $_SESSION['key']=='arti7785068889') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='arti7785068889') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='arti7785068889')
{
